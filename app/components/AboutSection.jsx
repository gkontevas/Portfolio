...
const AboutSection = () => {
  ...
  return (
    <section className="text-white px-0" id="about" style={{ fontFamily: "'Audiowide', cursive" }}>
     <div className="flex flex-col items-center md:flex-row gap-8 py-8 sm:py-16 xl:gap-20">
        <motion.div
        ...
        >
          ...
          {/* Image */}
          <motion.div
  className="relative w-full max-w-[400px] lg:max-w-[500px] mx-auto md:mx-0"
  initial={{ opacity: 0, y: 20 }}
  animate={{ opacity: 1, y: 0 }}
  transition={{ duration: 0.7, ease: "easeOut" }}
  onHoverStart={() => setIsHovered(true)}
...
/>
        ...
        <div className="mt-4 md:mt-0 w-full text-center md:text-left flex flex-col h-full">
