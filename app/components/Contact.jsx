...
const ContactForm = () => {
  ...
  return (
    <div className="min-h-screen w-full mx-auto flex items-center justify-start py-4 px-0 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col md:flex-row gap-6 lg:gap-8 w-full items-stretch">
          ...
          >
            <div className="flex-1 bg-[#121212] rounded-none sm:rounded-2xl border-x-0 sm:border border-[#9D4EDD]/30 shadow-lg shadow-[#9D4EDD]/10 relative overflow-hidden">
              ...
              <div className="p-6 md:p-8 lg:p-10 space-y-5 relative z-10 h-full flex flex-col">
                <motion.h2
                ...
                <form onSubmit={onSubmit} className="space-y-4 lg:space-y-6 flex-1 flex flex-col">
                  ...
                  <motion.div className="flex justify-center md:justify-start mt-auto">
                    <motion.button
                      type="submit"
          ...
          >
            <div className="flex-1 bg-[#121212] rounded-none sm:rounded-2xl border-x-0 sm:border border-[#9D4EDD]/30 shadow-lg shadow-[#9D4EDD]/10 relative overflow-hidden">
              ...
              <div className="p-6 md:p-8 lg:p-10 space-y-6 lg:space-y-10 relative z-10 h-full flex flex-col">
                ...
                <motion.div className="space-y-4 lg:space-y-6 mt-auto" variants={containerVariants}>
                  <motion.p
