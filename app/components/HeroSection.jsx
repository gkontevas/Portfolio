...
const HeroSection = () => {
  return (
    <section className='relative flex flex-col-reverse items-center justify-between h-screen px-4 overflow-hidden xl:flex-row md:px-10 lg:px-24'>
      {/* Left Section */}
       <div className="z-40 flex flex-col items-center justify-center flex-1 mb-6 text-center xl:mb-0 sm:items-start sm:text-left">
   <motion.h1
...
>
  Explore creativity, code, and collaboration. Here, ideas turn into interactive experiences and every line of code brings new possibilities. Let’s build something amazing together!
      ...
      >
        <Spline scene="https://prod.spline.design/f3Tb9mT378GDmn0P/scene.splinecode" />
      </motion.div>
      </div>
    </section>
  )
